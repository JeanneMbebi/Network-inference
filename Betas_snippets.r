Betas=function(Met, Time ){
  ...
  # a-Now the computation of coefficients at t0
  ...
  #save(AllTP, file="PosAllTPtoyex.RData")
  #save(RespMet, file="PosRespMettoyex.RData")
  #save(ALLTPMHCD, file="ALLTPMHCDtoyex.RData")
  #save(CoefDet, file="CoefDetPostoyex.RData")
  #save(RSS, file="RSSPostoyex.RData")
  #save(AllMod, file="AllModelstoyex.RData")
