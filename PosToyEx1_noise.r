...
RespMet[length(RespMet)+1]=ind3
AllTP[S,]=nSave3[,ind3]
save(AllTP, file="PosAllTPtoyex_noise10_1.RData")
save(RespMet, file="PosRespMettoyex_noise10_1.RData")
save(ALLTPMHCD, file="ALLTPMHCDtoyex_noise10_1.RData")
save(CoefDet, file="CoefDetPostoyex_noise10_1.RData")
save(RSS, file="RSSPostoyex_noise10_1.RData")
save(AllMod, file="AllModelstoyex_noise10_1.RData")
